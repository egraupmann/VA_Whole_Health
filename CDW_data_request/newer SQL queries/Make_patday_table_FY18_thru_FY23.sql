...
DECLARE @StartDateTime_ nvarchar(25) = '2017-10-01 00:00:00'
DECLARE @EndDateTime_ nvarchar(25) = '2023-09-30 23:59:59'
...
DROP TABLE IF EXISTS ORD_Fix_202309007D.WH_CIH.WH_CIH_FY18thuFY23_Visits_VA; 
SELECT * INTO ORD_Fix_202309007D.WH_CIH.WH_CIH_FY18thuFY23_Visits_VA FROM WH_CIH.temp_combined_visits; 
...
DROP TABLE IF EXISTS ORD_Fix_202309007D.WH_CIH.WH_CIH_PatdayFY18thuFY23_VA;
SELECT * INTO ORD_Fix_202309007D.WH_CIH.WH_CIH_PatdayFY18thuFY23_VA FROM WH_CIH.temp_va_patday; 
...
DECLARE @StartDateTime_ nvarchar(25) = '2017-10-01 00:00:00'
DECLARE @EndDateTime_ nvarchar(25) = '2018-09-30 23:59:59'
...
DROP TABLE IF EXISTS ORD_Fix_202309007D.WH_CIH.WH_CIH_PatdayFY18_CC;
SELECT * 
INTO ORD_Fix_202309007D.WH_CIH.WH_CIH_PatdayFY18_CC 
from WH_CIH.temp_pit_cih_patday;

select min (VisitDate) from WH_CIH.WH_CIH_PatdayFY18_CC 
select max (VisitDate) from WH_CIH.WH_CIH_PatdayFY18_CC 

/**** pull CIH and WH utilization from IVC ****/


DECLARE @StartDateTime_ nvarchar(25) = '2018-10-01 00:00:00'
DECLARE @EndDateTime_ nvarchar(25) = '2023-09-30 23:59:59'
...
DROP TABLE IF EXISTS WH_CIH.WH_CIH_PatdayFY19_23_CC_IVCCDS;
SELECT * 
INTO WH_CIH.WH_CIH_PatdayFY19_23_CC_IVCCDS
from WH_CIH.temp_ivccds_cih_patday;

select top 100 * from WH_CIH.WH_CIH_PatdayFY19_23_CC_IVCCDS
select min (VisitDate) from WH_CIH.WH_CIH_PatdayFY19_23_CC_IVCCDS
select max (VisitDate) from WH_CIH.WH_CIH_PatdayFY19_23_CC_IVCCDS

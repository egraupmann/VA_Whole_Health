...
/* updated 06/17/2022 | Claire Chen */

use ORD_Fix_202309007D;
go

drop proc if exists WH_CIH.apply_VA_CIH_exclusions;
go
create proc WH_CIH.apply_VA_CIH_exclusions 
AS
BEGIN
...
SELECT DISTINCT V.VisitSID
	...
	, CASE WHEN yoga_ST = 1 THEN 1
		...
		ELSE 0 END AS Yoga
INTO #cih_all_wide
FROM (SELECT DISTINCT VisitSID from WH_CIH.temp_cih_visits_long) V
...
with intermed as (
	...
	FROM #cih_all_wide V INNER JOIN WH_CIH.temp_cih_visits_long A on V.VisitSID = A.VisitSID WHERE V.Acup = 1 AND A.CIHType in ('Acup-Trad', 'Acup-BFA')
	UNION
	SELECT DISTINCT ScrSSN, PatientSID, V.VisitSID, VisitDate, CIHType, Sta6a, Tele, PrimaryStopCode, SecondaryStopCode
		, CPT, CPT_num_terms, CPT_codes, NT, NT_num_terms, NT_terms, NT_inclusions, LocName, A.LocationName, LN_inclusions
		, HF, HF_num_terms, HF_terms, HF_inclusions, CHAR4, CHAR4_code, StopCode
	FROM #cih_all_wide V INNER JOIN WH_CIH.temp_cih_visits_long A on V.VisitSID = A.VisitSID WHERE V.Bio = 1 AND A.CIHType in ('Biofeedback')
	UNION
	SELECT DISTINCT ScrSSN, PatientSID, V.VisitSID, VisitDate, CIHType, Sta6a, Tele, PrimaryStopCode, SecondaryStopCode
		, CPT, CPT_num_terms, CPT_codes, NT, NT_num_terms, NT_terms, NT_inclusions, LocName, A.LocationName, LN_inclusions
		, HF, HF_num_terms, HF_terms, HF_inclusions, CHAR4, CHAR4_code, StopCode
	FROM #cih_all_wide V INNER JOIN WH_CIH.temp_cih_visits_long A on V.VisitSID = A.VisitSID WHERE V.Chiro = 1 AND A.CIHType in ('Chiropractic')
	UNION
	SELECT DISTINCT ScrSSN, PatientSID, V.VisitSID, VisitDate, CIHType, Sta6a, Tele, PrimaryStopCode, SecondaryStopCode
		, CPT, CPT_num_terms, CPT_codes, NT, NT_num_terms, NT_terms, NT_inclusions, LocName, A.LocationName, LN_inclusions
		, HF, HF_num_terms, HF_terms, HF_inclusions, CHAR4, CHAR4_code, StopCode
	FROM #cih_all_wide V INNER JOIN WH_CIH.temp_cih_visits_long A on V.VisitSID = A.VisitSID WHERE V.Gima = 1 AND A.CIHType in ('Guided Imagery')
	UNION
	SELECT DISTINCT ScrSSN, PatientSID, V.VisitSID, VisitDate, CIHType, Sta6a, Tele, PrimaryStopCode, SecondaryStopCode
		, CPT, CPT_num_terms, CPT_codes, NT, NT_num_terms, NT_terms, NT_inclusions, LocName, A.LocationName, LN_inclusions
		, HF, HF_num_terms, HF_terms, HF_inclusions, CHAR4, CHAR4_code, StopCode
	FROM #cih_all_wide V INNER JOIN WH_CIH.temp_cih_visits_long A on V.VisitSID = A.VisitSID WHERE V.Hyp = 1 AND A.CIHType in ('Hypnosis')
	UNION
	SELECT DISTINCT ScrSSN, PatientSID, V.VisitSID, VisitDate, CIHType, Sta6a, Tele, PrimaryStopCode, SecondaryStopCode
		, CPT, CPT_num_terms, CPT_codes, NT, NT_num_terms, NT_terms, NT_inclusions, LocName, A.LocationName, LN_inclusions
		, HF, HF_num_terms, HF_terms, HF_inclusions, CHAR4, CHAR4_code, StopCode
	FROM #cih_all_wide V INNER JOIN WH_CIH.temp_cih_visits_long A on V.VisitSID = A.VisitSID WHERE V.Mass = 1 AND A.CIHType in ('Massage')
	UNION
	SELECT DISTINCT ScrSSN, PatientSID, V.VisitSID, VisitDate, CIHType, Sta6a, Tele, PrimaryStopCode, SecondaryStopCode
		, CPT, CPT_num_terms, CPT_codes, NT, NT_num_terms, NT_terms, NT_inclusions, LocName, A.LocationName, LN_inclusions
		, HF, HF_num_terms, HF_terms, HF_inclusions, CHAR4, CHAR4_code, StopCode
	FROM #cih_all_wide V INNER JOIN WH_CIH.temp_cih_visits_long A on V.VisitSID = A.VisitSID WHERE V.Med = 1 AND A.CIHType in ('Meditation')
	UNION
	SELECT DISTINCT ScrSSN, PatientSID, V.VisitSID, VisitDate, CIHType, Sta6a, Tele, PrimaryStopCode, SecondaryStopCode
		, CPT, CPT_num_terms, CPT_codes, NT, NT_num_terms, NT_terms, NT_inclusions, LocName, A.LocationName, LN_inclusions
		, HF, HF_num_terms, HF_terms, HF_inclusions, CHAR4, CHAR4_code, StopCode
	FROM #cih_all_wide V INNER JOIN WH_CIH.temp_cih_visits_long A on V.VisitSID = A.VisitSID WHERE V.Phys = 1 AND A.CIHType in ('Physical Therapy')
	UNION
	SELECT DISTINCT ScrSSN, PatientSID, V.VisitSID, VisitDate, CIHType, Sta6a, Tele, PrimaryStopCode, SecondaryStopCode
		, CPT, CPT_num_terms, CPT_codes, NT, NT_num_terms, NT_terms, NT_inclusions, LocName, A.LocationName, LN_inclusions
		, HF, HF_num_terms, HF_terms, HF_inclusions, CHAR4, CHAR4_code, StopCode
	FROM #cih_all_wide V INNER JOIN WH_CIH.temp_cih_visits_long A on V.VisitSID = A.VisitSID WHERE V.Taic = 1 AND A.CIHType in ('TaiChi')
	UNION
	SELECT DISTINCT ScrSSN, PatientSID, V.VisitSID, VisitDate, CIHType, Sta6a, Tele, PrimaryStopCode, SecondaryStopCode
		, CPT, CPT_num_terms, CPT_codes, NT, NT_num_terms, NT_terms, NT_inclusions, LocName, A.LocationName, LN_inclusions
		, HF, HF_num_terms, HF_terms, HF_inclusions, CHAR4, CHAR4_code, StopCode
	FROM #cih_all_wide V INNER JOIN WH_CIH.temp_cih_visits_long A on V.VisitSID = A.VisitSID WHERE V.Yoga = 1 AND A.CIHType in ('Yoga')
)
select *
INTO WH_CIH.temp_consolidated_methods_cih 
FROM intermed;
